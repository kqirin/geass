      ...
      return (
        <div className="min-h-screen bg-[#0b0b14] text-white flex items-center justify-center p-6">
          <div className="max-w-xl w-full bg-white/5 border border-white/10 rounded-3xl p-8">
            <h1 className="text-2xl font-black uppercase">Beklenmeyen UI Hatasi</h1>
            <p className="text-sm text-gray-300 mt-3">Sayfayi yenileyin. Sorun devam ederse loglari kontrol edin.</p>
          </div>
        </div>
      );
    }
